        ...
        <div class="detail-section map-section">
            <div class="section-header">
                ...
                <div class="map-actions">
                    <button v-if="location.mapImagePath" class="edit-btn" :class="{ 'save-btn': mapEditMode }"
                            @click="mapEditMode = !mapEditMode">
                        {{ mapEditMode ? t("locations.doneEditing") : t("locations.editMap") }}
                    </button>
                    <button class="edit-btn" @click="$emit('upload-map', location.id)"
                            :title="t('locations.uploadMapImage')">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            ...
            <div v-if="location.mapImagePath" class="map-container">
                ...
                <div v-if="mapEditMode" class="map-edit-tools">
                    ...
                    <div v-if="unplacedChildren.length === 0" class="no-unplaced">{{
                            t("locations.allChildrenPlaced")
                        }}
                    </div>
                    <div class="unplaced-list">
                        ...
                        >
                            <svg width="12" height="12" viewBox="0 0 14 14" fill="none">
                                <path d="M7 1v12M1 7h12" stroke="currentColor" stroke-width="1.8"
            ...
            <div v-else class="no-map">
                ...
                <button class="upload-map-btn" @click="$emit('upload-map', location.id)">{{
                        t("locations.uploadMap")
                    }}
                </button>
            </div>
        </div>
