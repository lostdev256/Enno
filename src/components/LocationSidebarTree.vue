  ...
  >
    <template #item="{ element }">
      <div class="tree-node-wrapper">
        <div class="tree-node" :class="{ selected: selectedId === element.id }" @click="handleSelect(element.id)">
          <div class="drag-handle">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 3h4M4 6h4M4 9h4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
          </div>
